...
const { PermissionsBitField, ButtonStyle, ActionRowBuilder, ButtonBuilder, EmbedBuilder, SlashCommandBuilder } = require(`discord.js`);
...
module.exports = {
    ...
    async execute (interaction, client) {
        ...
        .setDescription(`React with the buttons below to get the specified roles! (${role1})`)
        ...
        collector.on('collect', async (i) => {
            ...
            if (i.guild.members.me.roles.highest.position < role1.position) {
                i.update({ 
                    content: "My role is below the roles that I'm trying to give; I have shut this reaction role message down.", 
                    embeds: [], 
                    components: []
                });
                return;
            ...
            if (i.customId === 'button1') {
                ...
                i.reply({ 
                    content: `You now have the role : ${role1.name}`, 
                    ephemeral: true});
            }

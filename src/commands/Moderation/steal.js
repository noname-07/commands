...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (!interaction.member.permissions.has(PermissionsBitField.Flags.ManageEmojisAndStickers)) return await interaction.reply({ content: "You must have the Manage Emojis & Stickers permission to run this command!", ephemeral: true});
